            ...
            <Container>
                <Grid container spacing={3}>
                    ...
                    <Grid item md={8} xs={12} sx={{ padding: "0px 0px", mt: 4, color: "text.primary" }} >
                        ...
                        <Typography variant='h6' sx={{ my: 3 }} data-aos="fade-left" data-aos-once="true" >
                        ...
                        <Typography variant='h6'>I'm currently a graduate student working towards my Master of Engineering (M.Eng.) degree in Computer Science/Artificial Intelligence.</Typography>
                        <List >
                            ...
                            <ListItem>
                                ...
                                <ListItemText primary="Master of Engineering in Computer Science/Artificial Intelligence" primaryTypographyProps={{ fontSize: '18px' }}  ></ListItemText>
                            </ListItem>
                            <ListItem>
                                <ListItemIcon>
                                    <SchoolIcon sx={{ color: "text.primary" }} />
